...
from weightless.core.compose._compose_c import local
from weightless.core.compose._compose_c import compose
from weightless.core.compose._compose_c import tostring
...
class ComposeTest(TestCase):
    ...
    def testToStringGivesStackOfGeneratorsAKAcallStack(self):
        ...
        def f2():
            yield f1()
        c = compose(f2())
        result = """  File "%s", line 604, in f2
    yield f1()
  File "%s", line 602, in f1
